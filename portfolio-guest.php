...
// Query to get the last 10 images
            ...
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item active">
                  <a class="nav-link" href="portfolio-guest.php">Снимки </a>
                </li>
                <li class="nav-item">
      ...
      <div class="row text-center text-lg-start">
        <?php while ($row = mysqli_fetch_assoc($imagesResult)) : ?>
          <div class="col-lg-3 col-md-4 col-6">
            <a href="image_details_guest.php?id=<?php echo $row['id']; ?>" class="d-block mb-4 h-100">
