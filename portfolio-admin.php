        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                <li class="nav-item">
                  <a class="nav-link" href="index-admin.php">Начало <span class="sr-only">(current)</span></a>
                </li>
      ...
      <?php while ($row = mysqli_fetch_assoc($imagesResult)) : ?>
        <div class="col-lg-3 col-md-4 col-6">
          <div class="gallery-item">
            <a href="image_details_admin.php?id=<?php echo $row['id']; ?>" class="d-block mb-4 h-100">
              <img class="img-fluid img-thumbnail" style="height: 200px;" src="uploads/<?php echo $row['filename']; ?>" alt="">
            </a>
            <!-- Add a delete button -->
            <form method="POST" action="delete_image_admin.php">
